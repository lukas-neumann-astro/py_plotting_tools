...
def mpl_setup(
        figtype='paper-1/2', aspect=0.7, lw=None, ms=None, fs=None,
    ...
    figtype : {'paper-1/1', 'paper-1/2', 'paper-1/3', 'talk', float}
        This parameter specifies the type and width of the figure(s):
            ...
            * 'talk':      figure height = 4.0 inches
                           (larger lw, ms, fs)
            * 'talk-1/2':  figure height = 2.0 inches
                           (larger lw, ms, fs)
    ...
    elif figtype == 'talk-1/2':
        fw = slideheight/2 / aspect
    else:
        fw = figtype
